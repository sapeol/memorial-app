    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-background via-card to-background p-6">
      ...
      <Card className="w-full max-w-md p-8 bg-card/50 backdrop-blur border-border">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm">Start creating lasting tributes today</p>
        </div>
        ...
        <p className="text-center text-muted-foreground text-sm mt-6">
          ...
          <Link href="/sign-in" className="text-brand-foreground hover:text-brand-foreground dark:hover:text-brand-foreground">
            Sign in
          </Link>
        </p>
      </Card>
